...
class __TwigTemplate_0925c058491c295d879848a48286f3d066791dce2140aaaf5e8e435f9aa1bf03 extends \Twig\Template
{
...
<style>
    ...
    .bar-5 {width: ";
        // line 70
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 0, [], "array"), "nbr", []) * 100) / 5), "html", null, true);
        echo "%; height: 18px; background-color: #4CAF50;}
    .bar-4 {width: ";
        // line 71
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 1, [], "array"), "nbr", []) * 100) / 5), "html", null, true);
        echo "%; height: 18px; background-color: #2196F3;}
    .bar-3 {width: ";
        // line 72
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 2, [], "array"), "nbr", []) * 100) / 5), "html", null, true);
        echo "%; height: 18px; background-color: #00bcd4;}
    .bar-2 {width: ";
        // line 73
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 3, [], "array"), "nbr", []) * 100) / 5), "html", null, true);
    ...
    <div class=\"middle\">
        <div class=\"bar-container\">
            <div class=\"bar-4\">";
        // line 104
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 1, [], "array"), "nbr", []), "html", null, true);
    ...
    <div class=\"middle\">
        <div class=\"bar-container\">
            <div class=\"bar-3\">";
        // line 111
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 2, [], "array"), "nbr", []), "html", null, true);
    ...
    <div class=\"middle\">
        <div class=\"bar-container\">
            <div class=\"bar-2\">";
        // line 118
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 3, [], "array"), "nbr", []), "html", null, true);
    ...
    <div class=\"middle\">
        <div class=\"bar-container\">
            <div class=\"bar-5\">";
        // line 123
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["notes"] ?? $this->getContext($context, "notes")), 0, [], "array"), "nbr", []), "html", null, true);
